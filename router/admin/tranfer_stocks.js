...
module.exports = function (app) {
    ...
    app.post("/admin_tranfer_stocks/getStoresAndProducts", tranfer_stocks.loggedInadmin, tranfer_stocks.getStoresAndProducts)
    app.post("/admin_tranfer_stocks/create", tranfer_stocks.loggedInadmin, tranfer_stocks.create_new)
}